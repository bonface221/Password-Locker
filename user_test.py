...
class Testclass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_credentials = Credentials('johndoe','twitter', f'{Credentials.generate_password(8)}')
    ...
    def test_save_multiple_credentials(self):
        self.new_credentials.save_login_credentials()
        test_credential= Credentials('Test','twitter',Credentials.generate_password(8))
        test_credential.save_login_credentials()
        self.assertEqual(len(Credentials.credentials_list),2)

    def test_credential_exist(self):
        self.new_credentials.save_login_credentials()
        test_credential= Credentials('test', 'facebook',Credentials.generate_password(8))
        test_credential.save_login_credentials()

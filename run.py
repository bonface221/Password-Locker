            ...
            if user_exists(user_input):
                ...
                if password_exists(user_password):
                    ...
                    while True:
                        ...
                        print('\n')
                        print('Use these short codes : cc- create credentials, dc-display credentials, fc- find credentials, dd-delete credentials ex: exit')
                        ...
                        if short_code2 == 'cc':
                            ...
                            print('Enter preffered password .or type g - to generate automatically')
                            user_pass= input()
                            if user_pass =='g':
                            ...
                            save_credential(create_credentials(user_social,social_p,user_pass))

                            print('\n')
                            print(f'New {social_p} Password credential has been saved successfully' )
                            print('\n')

                        elif short_code2 == 'dc':
                            if display_credentials():
                                print('Here is a list of all your stored Credentials')
                                print('\n')

                                for credential in display_credentials():
                                    print(f'{credential.social_platform}...{credential.user_name} .......{credential.password}')

                                    print('\n')

                            else:
                                print('\n')
                                print('You don\'t seem to have any credentials stored ')
                                print('\n')
                            ...
                            if check_existing_credentials(search_handle):
                                ...
                                print(f'{found_handle.social_platform} has been found')
                                print('-'*10)

                                print(f'User name .......{found_handle.user_name}')
                                print(f'password .........{found_handle.password}')
                            
                            else:
                                print('That Social handle does not exist. Please check the spelling')

                        elif short_code2 == 'dd':
                            print('Are you sure you want to delete a credential! It will be lost forever!!')
